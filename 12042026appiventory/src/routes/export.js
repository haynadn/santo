...
router.get('/excel', requireLogin, async (req, res) => {
  ...
  try {
    ...
    sheet.columns = [
      ...
      { header: 'Merk/Type', key: 'merk_type', width: 20 },
      { header: 'Satuan', key: 'satuan', width: 10 },
      { header: 'Jumlah', key: 'stok_akhir', width: 12 },
      { header: 'Harga', key: 'harga', width: 15 },
      { header: 'Total Nilai', key: 'total_nilai', width: 18 },
      { header: 'Supplier', key: 'supplier', width: 20 },
      { header: 'Sumber Dana', key: 'sumber_pendanaan', width: 15 },
      { header: 'Posisi Ruangan', key: 'posisi_ruangan', width: 20 },
    ...
    rows.forEach((b, i) => {
      sheet.addRow({
        ...
        supplier: b.supplier || '-',
        merk_type: b.merk_type || '-',
        sumber_pendanaan: b.sumber_pendanaan || '-',
        posisi_ruangan: b.posisi_ruangan || '-',
        kondisi: b.kondisi || '-',
        lokasi: b.lokasi || '-',
        status: b.status || '-',
